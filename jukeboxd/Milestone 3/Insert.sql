INSERT INTO USERS (U_Username, U_FName, U_LName, U_PasswordHash, U_Email, U_Role) VALUES 
...
INSERT INTO SONG (S_Length, S_Name, S_Genre, AR_ID, AL_ID) VALUES 
...
(2, 12), (2, 13), (3, 14), (3, 15), (4, 16), (4, 17), (5, 18), (5, 19), (6, 20), (6, 21), (7, 22), (7, 23), (8, 24), (8, 25), (9, 26), (9, 27), (10, 28), (10, 29), (1, 30), (1, 31); 

INSERT INTO REVIEW (R_Text, R_Rating, R_TimeCreated, R_NumOfLikes, S_ID, ART_ID, AL_ID, U_Username) VALUES 
('Incredible production quality.', 5, '2024-05-21 10:00:00', 5, 2, NULL, NULL, 'AliceWonder'),
('A bit too slow for me.', 2, '2024-05-22 08:15:00', 1, 3, NULL, NULL, 'MelodyMaker'),
('This album changed my life.', 5, '2024-05-23 12:00:00', 12, NULL, NULL, 3, 'VinylVibes'),
('The guitar solo is insane!', 4, '2024-05-24 16:45:00', 3, 4, NULL, NULL, 'BassBoost'),
('Perfect for studying.', 5, '2024-05-25 22:30:00', 8, 9, NULL, NULL, 'SynthWave'),
('Not their best work.', 3, '2024-05-26 09:10:00', 0, NULL, 5, NULL, 'JazzCat'),
('Heavy and melodic.', 4, '2024-05-27 11:00:00', 4, 4, NULL, NULL, 'MetalHead'),
('Catchy but repetitive.', 3, '2024-05-28 14:20:00', 2, 6, NULL, NULL, 'PopPrincess'),
('Total vibe.', 5, '2024-05-29 19:00:00', 10, 10, NULL, NULL, 'LoFiLover'),
('Funky as promised.', 4, '2024-05-30 21:00:00', 6, 11, NULL, NULL, 'BobStoner');
